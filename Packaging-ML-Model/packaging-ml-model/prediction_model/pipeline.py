...
classification_pipeline = Pipeline(
    [
        ...
        ('MinMaxScale', MinMaxScaler()), # Normalization: MinMaxScaler
        ('LogisticClassifier',LogisticRegression(random_state=0)) # Logistic Regression => Create and Init the training model
    ]
)