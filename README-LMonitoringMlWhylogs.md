...
// WhyLogs Example
Basic => https://whylogs.readthedocs.io/en/latest/examples.html#basic-examples
Example                     Description
========================    ========================================================
...
WhyLabs => https://whylogs.readthedocs.io/en/latest/examples.html#whylabs
Integration                 Description
========================    ========================================================
- Writing profiles          Send profiles to your WhyLabs Dashboard
- Reference Profile         Send profiles as Reference (Static) Profiles to WhyLabs (Training Data)
...
https://nbviewer.org/github/whylabs/whylogs/blob/mainline/python/examples/integrations/writers/Writing_to_WhyLabs.ipynb
